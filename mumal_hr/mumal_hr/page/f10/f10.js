frappe.pages['f10'].on_page_load = function(wrapper) {
    ...
    frappe.call({
        method: 'mumal_hr.mumal_hr.page.f10.f10.get_default_company',
    ...
    function renderHTMLForm(companyName, employeeName) {
        frappe.call({
            method: 'mumal_hr.mumal_hr.page.f10.f10.get_all_company_data',
            args: {
            ...
            callback: function(r) {
                if (r.message) {
                    ...
                    var rendered_html = frappe.render_template('f10', { company: company });
    ...
    function getAttendanceData(companyName, employeeName) {
        frappe.call({
            method: 'mumal_hr.mumal_hr.page.f10.f10.get_employee_data',
            args: {
                company_name: companyName, 
                employee_name: employeeName 
            },
